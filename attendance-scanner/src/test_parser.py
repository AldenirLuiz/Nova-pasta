...
# Amostra de teste com nomes OCR-corrompidos
...
# Processa a amostra
result = parse_attendance_data(sample)

# Mostra resultados
print("=== Resultados do Parser ===")
print(f"Total de linhas: {result['total_lines']}")
print(f"Presentes: {result['present']}")
print(f"Ausentes: {result['absent']}")
print("\n=== Detalhes por Linha ===")

for d in result['details']:
    print("\nLinha original:")
    print(f"  {d['original_line']}")
    print("Nome limpo:")
    print(f"  {d['cleaned_name']}")
    print("Nome corrigido:")
    print(f"  {d['corrected_name']}")
    print("Nome canônico:")
    print(f"  {d.get('canonical_name')}")
    print("Score de correspondência:")
    print(f"  {d.get('match_score')}")
